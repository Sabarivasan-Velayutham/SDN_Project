...
sleep 1
sudo curl -X POST -d '{"port_name": "s1-eth1", "type": "linux-htb", "max_rate": "1000000", "queues": [{"max_rate": "30000"}, {"min_rate": "30000", "max_rate": "300000"}, {"min_rate": "300000", "max_rate": "1000000"}]}' http://localhost:8080/qos/queue/0000000000000001
